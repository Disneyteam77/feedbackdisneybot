...
async def cb_handler(c, m):
  ...
  if "feed" in cb_data:
      ...
      await c.send_message(chat_id=m.message.chat.id, text="Send your feed back here I will notify the admin if you face any problem ask here @disneyteamchat.", reply_markup=markup)
  ...
  if "yes" in cb_data:
      ...
      await m.message.delete()
      await c.send_message(chat_id=m.message.chat.id, text="Feedback sent successfully.  you will get reply soon join my channel @disneygrou")
